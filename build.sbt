...
homepage := Some(url("https://github.com/alltonp/spitalfields"))
...
pomExtra :=
    <scm>
      <url>git@github.com:alltonp/spitalfields.git</url>
      <connection>scm:git:git@github.com:alltonp/spitalfields.git</connection>
    </scm>
    <developers>
      <developer>
        <id>alltonp</id>
